  ...
  <!--header-->
		...
		<div class="header-top">
			...
			<div class="header-top-in">			
				<div class="logo">
						<a href=""></a>
					<h1><span style="color: white;">网上租车系统</span></h1>
				</div>
				<div class="header-in">
					...
					<h2 class=" products-in">新车推荐 &nbsp;&nbsp;<a href="${ctx}/car_uCarList.do"><span style="color: red">更多>>></span></a></h2>
						 ...
						 <c:if test="${(l.index) % 4 == 0 }">
						  ...
						  <div class="col-md-3 md-col">
							<div class="col-md">
								<a href="${ctx}/car_uCar.do?id=${newest.id}" class="compare-in"><img  src="upload/${newest.carImage}" alt="${newest.carType}" style="width: 239.21px;height: 150.71px"/></a>	
					...
					<h2 class="products-in">好车推荐 &nbsp;&nbsp;<a href="${ctx}/car_uCarList.do?isRecommend=1"><span style="color: red">更多>>></span></a></h2>
					 <c:forEach items="${recommendList}" var="recommend" varStatus="l">
						 <c:if test="${(l.index) % 4 == 0 }">
						  ...
						  <div class="col-md-3 md-col">
							<div class="col-md">
								<a href="${ctx}/car_uCar.do?id=${recommend.id}"><img  src="upload/${recommend.carImage}" alt="${recommend.carType}" style="width: 239.21px;height: 150.71px"/></a>	
								<div class="top-content">
									<div class="white">
					...
					<h2 class="products-in">打折优惠 &nbsp;&nbsp;<a href="${ctx}/car_uCarList.do?isDiscount=1"><span style="color: red">更多>>></span></a></h2>
					 <c:forEach items="${discountList}" var="discount" varStatus="l">
						 <c:if test="${(l.index) % 4 == 0 }">
						  ...
						  <div class="col-md-3 md-col">
							<div class="col-md">
								<a href="${ctx}/car_uCar.do?id=${discount.id}"><img  src="upload/${discount.carImage}" alt="${discount.carType}" style="width: 239.21px;height: 150.71px"/></a>	
								<div class="top-content">
									<div class="white">
