<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
   <%@include file="/common/taglibs.jsp"%>  <!-- 引入这个页面ctx被设置值，引入即可获取项目路径。 -->
				    ...
				    <div class="flexslider">
							  ...
							  <ul class="slides">
								<li data-thumb="${car.carImage}">
									<div class="thumb-image"> <img src="upload/${car.carImage }" data-imagezoom="true" class="img-responsive"> </div>
								</li>
<%-- 								<li data-thumb="${car.carImage}"> --%>
