...
public class Main {
    ...
    public void test_monitor_sys() {
        ...
        AlipayHeartbeatSynRequestBuilder builder = new AlipayHeartbeatSynRequestBuilder()
            ...
            .setNetworkType("LAN").setProviderId("2088102169136450") // 设置系统商pid
    ...
    public void test_trade_pay(AlipayTradeService service) {
        ...
        String sellerId = "rirpxd7231@sandbox.com";
...
@Test
    ...
    public void test_trade_refund() {
        ...
        String outTradeNo = "tradeprecreate14869735371213238852";
    ...
    public void test_trade_precreate() {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                dumpResponse(response);
///Users/sudo/Desktop/qr-%s.png E:\secret_key_tools_RSA_win
                // 需要修改为运行机器上的路径
